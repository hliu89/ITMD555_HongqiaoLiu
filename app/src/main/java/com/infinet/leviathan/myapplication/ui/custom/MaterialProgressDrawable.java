...
package com.infinet.leviathan.myapplication.ui.custom;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        // progress circle_primary should currently display. As the progress circle_primary is
        ...
        /**
         * @param centerRadius Inner radius in px of the circle_primary the progress
         *                     spinner arc traces.
         */
