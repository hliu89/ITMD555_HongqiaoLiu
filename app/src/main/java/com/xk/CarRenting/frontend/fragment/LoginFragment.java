...
public class LoginFragment extends BaseFragment {
    ...
    private void signUp() {
        ...
        CallServer.getRequestInstance().add(getContext(), Constant.reuqest_register, registerRequest, new HttpListener<JSONObject>() {
            @Override
...
//                }
    ...
    private void login() {
        ...
        CallServer.getRequestInstance().add(getContext(), Constant.request_login, loginRequest, new HttpListener<JSONObject>() {
            @Override
            public void onSucceed(int what, Response<JSONObject> response) {
                JSONObject jsonObject = response.get();
                try {
