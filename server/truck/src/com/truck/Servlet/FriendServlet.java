...
public class FriendServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 1890676480879979943L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("queryFriend")) {
			...
			boolean caredAFriend = userDao.FollowAFriend(myPhone, otherPhone);
			...
			String myPhone = (String) request.getParameter("myPhone");
			String otherPhone = (String) request.getParameter("otherPhone");
			boolean cancelCaredAFriend = userDao.cancelFollowAFriend(myPhone, otherPhone);
			JSONObject object = new JSONObject();
